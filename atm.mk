atm.exe : client.o login.o create.o change.o deposit.o withdraw.o balance.o statement.o total_balance.o admin.o
	gcc client.o login.o create.o change.o deposit.o withdraw.o balance.o statement.o total_balance.o admin.o -o atm.exe
